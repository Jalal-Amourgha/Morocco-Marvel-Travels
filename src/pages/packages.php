...
<head>
  ...
  <title>Packages | Morocco Marvel Travel</title>
</head>
...
<body>
  ...
  <div class="page-header">
    <img src="../images/packages.jpg" alt="packages img">
    <h1>Packages</h1>
    <div class="svg-box">
  ...
  <section class="packages-deals">
    <div class="container">
      <div class="title-section">
        <h1>Packages</h1>
        <p>The most popular tour packages</p>
      </div>
      <div class="row">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-12 mb-4">
            <div class="package-box">
              ...
              <div class="text-center mt-4 mb-4">
                ...
                <button class="arrow-btn">Book Now</button>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-12 mb-4">
      ...
      <button class="show-more-btn" id="showMoreBtn" onclick="morePackages()">Show More</button>
